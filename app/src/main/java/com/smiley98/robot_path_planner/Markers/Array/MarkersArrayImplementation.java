...
import com.smiley98.robot_path_planner.Markers.Array.Containers.IMarkerOperations;
...
public class MarkersArrayImplementation implements IMarkers {
    ...
    private final IMarkerOperations[] mMarkers = new IMarkerOperations[Type.values().length];
